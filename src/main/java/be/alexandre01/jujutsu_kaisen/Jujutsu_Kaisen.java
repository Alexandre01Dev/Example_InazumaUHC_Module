package be.alexandre01.jujutsu_kaisen;
...
import be.alexandre01.jujutsu_kaisen.listeners.*;
import be.alexandre01.jujutsu_kaisen.roles.KentoNanami;
import be.alexandre01.jujutsu_kaisen.roles.SatoruGojo;
import be.alexandre01.jujutsu_kaisen.timers.DelayedTimeChangeTimer;
...
public class Jujutsu_Kaisen extends PresetData implements IPreset {
    ...
    public String getPackageName() {
        return "be/alexandre01/jujutsu_kaisen";
    }
